...
(1, 'Ultrabook', 'Equipamento de ultima geração', 3969.56, 7, 2),
(2, 'Tablet Android', 'Tablet Android E34 128gb', 1000.00, 7, 5),
(3, 'Tv', 'Tv 55polegadas smart', 5400.00, 10, 7),
(4, 'Iphone 15proMax ', '128gb cores azul brnaco e rosa', 4125.55, 6, 2),
(5, 'ipad Mini', '64gb 6ram cor preta', 650.00, 6, 4),
(6, 'Xbox Series S', 'Velocidade e desempenho de última geração', 1997.00, 5, 11),
(7, 'Notebook motoin', 'Descrição: Intel Dual Core 4GB de RAM, 128GB SSD e Tela 14,1 polegadas', 1213.65, 8, 10);
